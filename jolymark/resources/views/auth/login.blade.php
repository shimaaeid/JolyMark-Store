          ...
          <div class="card-body">
            ...
            @csrf
                ...
                <div class="form-label-group text-center">
                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email"  required autocomplete="email" autofocus placeholder="Email address">
        ...
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" method="POST" action="{{ route('register') }}">
              ...
              <div class="form-label-group text-center">
                <input id="nat_id" type="text" class="form-control @error('nat_id') is-invalid @enderror" placeholder="National ID" name="nat_id" required autocomplete="name" autofocus>
